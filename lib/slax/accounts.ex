defmodule Slax.Accounts do
  ...
  @doc """
  Gets a user by email|username and password.

  ## Examples

      iex> get_authenticated_user("foo@example.com", "correct_password")
      %User{}

      iex> get_authenticated_user("foo_username", "correct_password")
      %User{}

      iex> get_authenticated_user("foo@example.com", "invalid_password")
      nil

      iex> get_authenticated_user("foo_username", "invalid_password")
      nil
